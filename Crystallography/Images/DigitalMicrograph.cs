...
public class DigitalMicrograph
{
    public class Property
    {
        ...
        public bool IsFFT { get; set; } = false;
    ...
    public class Loader
    {
        ...
        public Loader(string fileName)
        {
            ...
            var readInt = Version == 4 ?
                new Func<long>(() => { byte[] i = new byte[8]; br.Read(i, 0, 8); return BitConverter.ToInt64([.. i.Reverse()], 0); }) :
                new Func<long>(() => { byte[] i = new byte[4]; br.Read(i, 0, 4); return BitConverter.ToInt32([.. i.Reverse()], 0); });
