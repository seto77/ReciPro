...
namespace Crystallography
{
    ...
    {
        public static Complex TwoPiI = new Complex(0, 2 * Math.PI);
    ...
    public static class UniversalConstants
    {
        ...
        public static class Convert
        {
            ...
            /// <returns></returns>
            public static double NeutronVelocityToWavelength(double velocity)
                => h / n0 / velocity * 1.0E3;
            ...
            /// <param name="velocity"></param>
            /// <returns></returns>
            public static double WavelengthToNeutronVelocity(double wavelength)
            ...
            /// <param name="velocity"></param>
            /// <returns></returns>
            public static double NeutronVelocityToNeutronEnergy(double velocity)
            ...
            /// <returns></returns>
            public static double WaveLengthToElectronEnergy(double waveLength)
            {
                //U =voltage
            ...
            /// <returns></returns>
            public static double WavelengthToXrayEnergy(double waveLength)
            ...
            /// <param name="velocity"></param>
            /// <returns></returns>
            public static double WaveLengthToNeutronEnergy(double wavelength)
            ...
            /// <returns></returns>
            public static double EnergyToXrayWaveLength(double energy)
            ...
            /// <param name="kiloVoltage"></param>
            /// <returns></returns>
            public static double EnergyToElectronWaveLength(double kiloVoltage)
            {
                //U =voltage
                //WaveLength = h / Math.Sqrt ( 2 * m0 * e0 * U * ( 1 + e0 * U / 2 / m0 / c^2 ) )
            ...
            /// <param name="kiloVoltage"></param>
            /// <returns></returns>
            public static double EnergyToElectronWaveNumber(double kiloVoltage)
            {
                //U =voltage
                //WaveLength = h / Math.Sqrt ( 2 * m0 * e0 * U * ( 1 + e0 * U / 2 / m0 / c^2 ) )
            ...
            /// <param name="energy"></param>
            /// <returns></returns>
            public static double EnergyToNeutronWaveLength(double energy)
...
alpha particle-electron mass ratio                     7294.299 5347         0.000 0056
...
alpha particle mass energy equivalent in MeV           3727.379 239          0.000 082             MeV
...
atomic mass constant                                   1.660 538 920 e-27    0.000 000 073 e-27    kg
...
atomic mass unit-hartree relationship                  3.423 177 6838 e7     0.000 000 0034 e7     E_h
atomic mass unit-hertz relationship                    2.252 342 7164 e23    0.000 000 0023 e23    Hz
atomic mass unit-inverse meter relationship            7.513 006 6027 e14    0.000 000 0075 e14    m^-1
...
atomic mass unit-kilogram relationship                 1.660 538 920 e-27    0.000 000 073 e-27    kg
...
deuteron-electron mass ratio                           3670.482 9644         0.000 0028
deuteron g factor                                      0.857 438 2306        0.000 000 0072
...
deuteron mag. mom. to nuclear magneton ratio           0.857 438 2306        0.000 000 0072
...
deuteron mass energy equivalent in MeV                 1875.612 858          0.000 041             MeV
...
electron-deuteron mass ratio                           2.724 437 1100 e-4    0.000 000 0021 e-4
electron g factor                                      -2.002 319 304 361 63 0.000 000 000 000 36
...
electron-helion mass ratio                             1.819 543 0765 e-4    0.000 000 0020 e-4
electron mag. mom.                                     -928.476 430 e-26     0.000 021 e-26        J T^-1
electron mag. mom. anomaly                             1.159 652 180 81 e-3  0.000 000 000 18 e-3
electron mag. mom. to Bohr magneton ratio              -1.001 159 652 180 81 0.000 000 000 000 18
electron mag. mom. to nuclear magneton ratio           -1838.281 9705        0.000 0014
...
electron mass in u                                     5.485 799 0957 e-4    0.000 000 0042 e-4    u
electron molar mass                                    5.485 799 0957 e-7    0.000 000 0042 e-7    kg mol^-1
...
electron-neutron mass ratio                            5.438 673 4472 e-4    0.000 000 0047 e-4
electron-proton mag. mom. ratio                        -658.210 6848         0.000 0054
electron-proton mass ratio                             5.446 170 2189 e-4    0.000 000 0042 e-4
electron-tau mass ratio                                2.875 92 e-4          0.000 26 e-4
electron to alpha particle mass ratio                  1.370 933 5561 e-4    0.000 000 0010 e-4
...
electron-triton mass ratio                             1.819 200 0656 e-4    0.000 000 0020 e-4
electron volt                                          1.602 176 565 e-19    0.000 000 035 e-19    J
electron volt-atomic mass unit relationship            1.073 544 151 e-9     0.000 000 024 e-9     u
...
hartree-atomic mass unit relationship                  2.921 262 3252 e-8    0.000 000 0029 e-8    u
...
helion-electron mass ratio                             5495.885 2743         0.000 0062
helion g factor                                        -4.255 250 612        0.000 000 050
...
helion mass energy equivalent in MeV                   2808.391 481          0.000 062             MeV
...
hertz-atomic mass unit relationship                    4.439 821 6698 e-24   0.000 000 0044 e-24   u
...
inverse meter-atomic mass unit relationship            1.331 025 0515 e-15   0.000 000 0013 e-15   u
...
molar Planck constant                                  3.990 312 7184 e-10   0.000 000 0040 e-10   J s mol^-1
molar Planck constant times c                          0.119 626 565 80      0.000 000 000 12      J m mol^-1
...
neutron Compton wavelength                             1.319 590 9071 e-15   0.000 000 0014 e-15   m
neutron Compton wavelength over 2 pi                   0.210 019 415 72 e-15 0.000 000 000 23 e-15 m
neutron-electron mag. mom. ratio                       1.040 668 82 e-3      0.000 000 25 e-3
neutron-electron mass ratio                            1838.683 6601         0.000 0016
...
neutron mass energy equivalent                         1.505 349 630 e-10    0.000 000 066 e-10    J
neutron mass energy equivalent in MeV                  939.565 378           0.000 021             MeV
...
nuclear magneton in eV/T                               3.152 451 2611 e-8    0.000 000 0032 e-8    eV T^-1
...
proton Compton wavelength                              1.321 409 8565 e-15   0.000 000 0013 e-15   m
proton Compton wavelength over 2 pi                    0.210 308 910 51 e-15 0.000 000 000 21 e-15 m
proton-electron mass ratio                             1836.152 6721         0.000 0014
proton g factor                                        5.585 694 712         0.000 000 046
...
proton-muon mass ratio                                 8.880 243 30          0.000 000 22
...
shielded proton mag. mom. to nuclear magneton ratio    2.792 775 597         0.000 000 030
...
triton-electron mass ratio                             5496.921 5256         0.000 0062
triton g factor                                        5.957 924 895         0.000 000 076
...
triton mass energy equivalent in MeV                   2808.921 004          0.000 062             MeV
...
unified atomic mass unit                               1.660 538 920 e-27    0.000 000 073 e-27    kg
