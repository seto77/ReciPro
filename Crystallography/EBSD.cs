...
namespace Crystallography
{
    ...
    public sealed class EbsdMasterPattern
    {
        ...
        /// <summary>
        /// 六方格子の 2 半球菱形配列 index に対称操作を適用する。260331Cl 追加
        /// </summary>
        ...
        public static (double x, double y) HexAxialToCartesian(int u, int v, double spacing)
            => ((u + v * 0.5) * spacing, v * Hex_srt * spacing);
