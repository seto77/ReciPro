...
/// <summary>OpenGL用の色と材質を表すクラス Crystal.OpenGLで頻繁に使われるので、仕様変更は注意</summary>
public class Material
{
    ...
    #region 標準の材質
    /// <summary>標準の材質のタプル.  Ambient = 0.2f, Diffuse = 0.5f, Specular = 0.6f, SpecularPow = 4.0f, Emission = 0.4f</summary>
