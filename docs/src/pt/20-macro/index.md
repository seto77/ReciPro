...
ReciPro.Crystal.*      # Cristal atual: ler, criar, editar
...
ReciPro.SpotID.*       # Spot ID (v2): detecção de pontos e busca de orientação
ReciPro.StructureViewer.*  # Visualizador de estrutura: exportação de imagem e modelo 3D
