...
- **Temari** não é um ajuste, mas uma tabela calculada (Temari dataset-factors v1.0.0, CC-BY-4.0, a partir de um cálculo de campo autoconsistente de Dirac completo). Cobre **apenas átomos neutros Z = 1–86**: íons e Z = 87–98 não têm entrada, portanto suas curvas são omitidas e suas células ficam em branco em vez de preenchidas com valores de átomo neutro.
