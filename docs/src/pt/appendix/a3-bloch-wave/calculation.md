...
!!! note "Quanto pesa a cauda de Mott–Bethe"
    A parte além de $s = 6$ Å⁻¹ contribui com 1,5–4,8 % de $f'(0)$ (80–300 kV, $B = 0{,}3\text{–}1{,}0$ Å², Si/Fe/Au, $|\mathbf g|/2 \le 25$ nm⁻¹; 1,3–3,7 % a 20 kV). Trocar o modelo da cauda altera $f'$ em apenas 0,04–0,43 %, e os observáveis simulados (CBED, STEM, HRTEM, EBSD) em no máximo 0,45 %. Usar o Temari em vez do ajuste de Peng abaixo de 6 Å⁻¹ altera $f'(0)$ em 0,06–0,27 %. As tabelas do Temari são valores calculados publicados sem limite de erro certificado (`certification_status = not_certified`).
