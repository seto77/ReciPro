...
| 方向键 — **TEM 样品台** | 逐步改变样品台倾角（先勾选 **启用方向键**） |
...
打开一个窗口，将衍射图样与双倾（或旋转）**TEM 样品台**联动。设置样品台倾角会更新图样和晶体取向，可达取向可在极射赤平投影上显示（v4.914 新增）。在极射赤平投影上左键双击会将样品台倾角设为该点，勾选 **启用方向键** 后可用方向键逐步改变倾角。
