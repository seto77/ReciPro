...
Полный отчёт с количественными кривыми и анализом пространственных частот доступен в PDF: [Сравнение расчётов STEM-EDX в py_multislice и ReciPro (v4.945)](../../assets/references/STEM_EDX_pyms_comparison.pdf).
