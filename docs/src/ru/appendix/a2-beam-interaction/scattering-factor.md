...
**Атомный фактор рассеяния** (или *форм-фактор*) измеряет, насколько сильно отдельный атом рассеивает падающий пучок как функцию переменной рассеяния $s=\sin\theta/\lambda$. Три вида излучения взаимодействуют с совершенно разными частями атома, поэтому их факторы рассеяния имеют разные порядки величины, единицы и угловую зависимость. Это главная причина, по которой вкладка **Scattering factors** выглядит настолько по-разному для рентгеновского, электронного и нейтронного пучка.
...
Поскольку рассеиватель точечный, $b$ **не зависит от $s$** — спада форм-фактора нет, поэтому вкладка **Scattering factors** не строит кривую для нейтронов, а вместо этого показывает таблицу длин рассеяния.
...
- [3. Взаимодействие пучка → вкладка Scattering factors](../../3-beam-interaction.md#scattering-factors-tab)
