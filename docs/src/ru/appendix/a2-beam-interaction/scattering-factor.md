...
ReciPro предлагает четыре источника $f_e(s)$ — три подогнанные параметризации и одну вычисленную таблицу:
