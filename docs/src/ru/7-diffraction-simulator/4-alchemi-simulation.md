...
```text
basis 347 (184 + 163)   F(s) ≤ 6.20 Å⁻¹   expanded-basis 6.7e-3   ⚠ пригодность для подгонки НЕ оценивалась   ⚠ Experimental: количественно проверено только для beta-AlCo [001] при 250 кэВ
```
