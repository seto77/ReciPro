...
| Клавиши-стрелки — **держатель ПЭМ** | Пошагово изменять наклон держателя (сначала отметьте **Включить клавиши со стрелками**) |
