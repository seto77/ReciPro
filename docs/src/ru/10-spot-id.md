...
Если у вас нет изображения для загрузки, вы всё равно можете искать кандидатные оси зоны, вручную вводя геометрию картины электронной дифракции с выделенной области (SAED). Введите условия наблюдения TEM и геометрию рефлексов, затем нажмите **Search zone axes**, чтобы найти кандидатные ориентации кристалла.

### TEM condition

Введите условия наблюдения TEM (ускоряющее напряжение, камерную длину и т. д.).
...
**Three sides mode** : Введите длины трёх сторон треугольника, одной из вершин которого является direct spot.

**Two sides and an angle mode** : Введите длины двух сторон (включая direct spot) и угол между ними.
