...
여기서 $\sigma_n(E,z)$ 는 원자 위치 $\mathbf r_n$ 근방에서 에너지 $E$, 깊이 $z$ 의 후방산란 채널로 들어가는 비탄성 산란에 대한 가중치이다. 선원항은 결맞은 진폭 합이 아니라 강도로서 더해지는데, 이는 비탄성 산란이 서로 다른 선원 위치 사이의 위상 관계를 파괴한다고 가정하기 때문이다.
