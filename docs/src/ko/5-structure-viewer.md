...
**동영상 저장**은 아래의 동영상 설정 대화 상자를 엽니다. 회전 속도, 녹화 시간, 방향(현재 투영, 방향 지수 또는 격자면), 코덱(H.264 / H.265)과 인코딩 속도를 설정한 다음 **OK**를 눌러 MP4 파일을 생성합니다.
...
투영의 중심을 지정한 좌표로 설정합니다. 임의의 좌표를 입력하려면 **사용자 지정**을 켜세요.
