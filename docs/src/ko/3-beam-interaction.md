...
- **Temari**는 적합이 아니라 계산된 표입니다(Temari dataset-factors v2.0.0, CC-BY-4.0. 완전 Dirac 자기무모순장 계산에서 얻음). **중성 원자 Z = 1–86만** 지원하며, 이온과 Z = 87–98에는 값이 없습니다. 중성 원자 값으로 채우지 않고 곡선을 그리지 않으며 표의 셀은 비워 둡니다.
