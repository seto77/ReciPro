...
ReciPro.Crystal.*      # Cristal actual: leer, crear, editar
...
ReciPro.SpotID.*       # Spot ID (v2): detección de puntos y búsqueda de orientación
ReciPro.StructureViewer.*  # Visor de estructura: exportación de imagen y modelo 3D
