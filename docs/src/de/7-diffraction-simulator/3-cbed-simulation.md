...
![Input parameters](../../assets/cap-de-auto/FormDiffractionSimulatorCBED.groupBoxInputParameters.png)
...
![Output parameters](../../assets/cap-de-auto/FormDiffractionSimulatorCBED.groupBoxOutput.png)
