...
These distributions are computed by the same Monte-Carlo engine as [Electron trajectory](13-electron-trajectory.md) and are used to weight the master pattern.
