...
ReciPro.Crystal.*      # Current crystal: read, create, edit
...
ReciPro.SpotID.*       # Spot ID (v2): spot detection and orientation search
ReciPro.StructureViewer.*  # Structure Viewer: image and 3D-print model export
