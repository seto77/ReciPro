...
## Scheda Elementi e posizioni

Laddove la scheda **Matrice** elenca le operazioni mantenute e perse sotto forma di tabella, questa scheda mostra la stessa informazione in modo *geometrico*, nelle due figure che i cristallografi già leggono affiancate nel Vol. A delle ITA: a sinistra, il [diagramma degli elementi di simmetria](symbols-and-diagrams.md#symmetry-element-diagram) del genitore (assi, piani e centri di inversione); a destra, il **diagramma delle posizioni generali** del genitore. Entrambe seguono un'unica regola di colore — **ciò che sopravvive in $H$ è nero, ciò che va perduto è giallo**, con la cella elementare disegnata in blu al di sotto — cosicché la scheda risponde a colpo d'occhio: quali elementi di simmetria si rompono, e come si suddivide l'orbita della posizione generale, quando il cristallo si trasforma da $G$ al sottogruppo $H$. La direzione di proiezione (⟂ *a*, *b* o *c*) è scelta automaticamente per il sistema cristallino del genitore, e l'intestazione indica la relazione, il suo tipo e indice, e la proiezione.

**Sinistra — elementi di simmetria.**

- La sovrapposizione disegna in nero gli elementi di simmetria ricostruiti direttamente dall'insieme di operazioni di $H$ stesso, sopra gli elementi del genitore andati perduti, in giallo — così gli elementi mantenuti sono esattamente quelli che ricompaiono in $H$, senza doverli indovinare simbolo per simbolo.
- Un elemento di simmetria che degrada a uno di ordine inferiore è mostrato con il solo simbolo superstite: dove un asse di ordine 4 conserva soltanto il suo asse di ordine 2, compare unicamente il **simbolo nero di ordine 2**. Un elemento perso è stampato in giallo solo dove nulla sopravvive nel suo luogo geometrico, così la simmetria superstite resta leggibile.

La figura di sinistra tratta tre situazioni, a seconda di come la cella del sottogruppo si rapporta a quella del genitore:

- **Stessa cella convenzionale** — sottogruppi *translationengleiche* (*t*-) e sottogruppi *klassengleiche* (*k*-) che rimuovono soltanto vettori di centratura ($\det$ della base del sottoreticolo $= 1$). Qui gli elementi di $H$ vivono nella cella del genitore, cosicché la sovrapposizione è una figura di una sola cella del genitore. (Una relazione *k*- che rimuove la centratura, ad es. centrato $I$ o $F$ $\to$ primitivo, fa diventare gialli gli assi elicoidali e i piani di slittamento generati dalla centratura.)
- **Ingrandimento di cella nel piano** — relazioni *k*- o isomorfe il cui ingrandimento giace nel piano *a*–*b* ($a'=n_a a$, $b'=n_b b$, con *c* invariato) in un genitore ortorombico, tetragonale o cubico. La cella ingrandita è disegnata (proiettata ⟂ *c*) come una griglia $n_a\times n_b$ di tessere della cella del genitore, e **ogni tessera è colorata in modo indipendente**: un elemento di simmetria mantenuto in $H$ appare in nero nelle tessere in cui quella copia sopravvive, e in giallo dove l'ingrandimento della cella l'ha rimosso — così un raddoppio di cella si vede direttamente come una copia su due che diventa gialla.
- **Altrimenti** (ingrandimento lungo l'asse di vista $c$, cambi di cella obliqui/non ortogonali, genitori esagonali/trigonali/monoclini) la simmetria perduta non può essere disegnata senza ambiguità in una proiezione 2-D, cosicché la scheda mostra una breve nota che rimanda alle schede **Domini e geminazioni** e **Nuove riflessioni**, che già contengono l'informazione sulla simmetria reticolare perduta per quei casi.

**Destra — posizioni generali.** Sotto $G$ tutti i punti disegnati formano un'unica orbita (una sola posizione generale); sotto $H$ quell'orbita si suddivide in $[G:H]$ sotto-orbite (confronta la scheda **Suddivisione orbita**). La sotto-orbita che contiene il punto rappresentativo — l'insieme che resta un'unica posizione generale di $H$ — è disegnata in **nero**; i punti delle altre sotto-orbite, non più equivalenti ad essa una volta abbassata la simmetria, sono **gialli**. Dove la proiezione fa coincidere due punti equivalenti si usa il *cerchio diviso* standard delle ITA: un cerchio suddiviso da una linea verticale, con una virgola che contrassegna la metà speculare e un'etichetta di altezza (`+`, `½−`, …) accanto a ciascuna metà. **Se una metà sopravvive in $H$ e l'altra va perduta, la linea di divisione, la virgola e l'etichetta di altezza della metà perduta sono disegnate in giallo**, così una posizione persa per metà si legge direttamente dalla figura. La colorazione dell'orbita è mostrata per le relazioni a cella invariata (*t*- e *k*- che rimuovono la centratura); per le relazioni con ingrandimento di cella il pannello destro mostra invece una breve nota.

Per i gruppi spaziali R mostrati nell'impostazione ad assi romboedrici (Rho), nessuna delle due figure può essere disegnata in questa proiezione; la scheda mostra invece una nota, ed entrambi i diagrammi sono disponibili nell'impostazione ad assi esagonali (Hex) dello stesso gruppo spaziale R.

![Scheda Elementi e posizioni](../../../assets/cap-it-auto/FormGroupRelations-tabElements.png)
