...
| Tasti freccia — **TEM holder** | Avanzare l'inclinazione del portacampioni a passi (spunta prima **Abilita tasti freccia**; funziona con qualsiasi finestra di ReciPro in primo piano) |
...
Apre una finestra che collega il pattern di diffrazione a un **TEM holder** a doppia inclinazione (o a rotazione). L'impostazione degli angoli di inclinazione del portacampioni aggiorna il pattern e l'orientazione del cristallo, e le orientazioni raggiungibili possono essere mostrate su uno stereogramma (aggiunto in v4.914). Un doppio clic sinistro sullo stereogramma imposta l'inclinazione del portacampioni su quel punto, e spuntare **Abilita tasti freccia** consente ai tasti freccia di avanzare l'inclinazione a passi. Finché questa finestra è aperta, i tasti freccia funzionano qualunque sia la finestra di ReciPro in primo piano.
