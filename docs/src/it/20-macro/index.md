...
ReciPro.SpotID.*       # Spot ID (v2): rilevamento spot e ricerca dell'orientazione
ReciPro.StructureViewer.*  # Visualizzatore di struttura: esportazione di immagini e modelli 3D
