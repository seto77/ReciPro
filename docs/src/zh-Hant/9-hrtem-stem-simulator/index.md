...
| <kbd>CTRL</kbd>+<kbd>C</kbd> (聚焦於影像格線時) | 將影像以中繼檔 (metafile) 複製到剪貼簿 |
...
![Image mode](../../assets/cap-zh-Hant-auto/FormImageSimulator.splitContainer1.flowLayoutPanelModeSelection.groupBoxImageMode.png){align=left}

HRTEM、Potential 或 STEM。<div style="clear: both;"></div>

![Sample](../../assets/cap-zh-Hant-auto/FormImageSimulator.splitContainer1.flowLayoutPanelModeSelection.groupBoxSampleProperty.png){ align=left style="clear: both" }
...
![Objective aperture (HRTEM option)](../../assets/cap-zh-Hant-auto/FormImageSimulator.splitContainer1.groupBoxOpticalProperty.groupBoxHREMoption1.png)
...
![STEM options (optical)](../../assets/cap-zh-Hant-auto/FormImageSimulator.splitContainer1.groupBoxOpticalProperty.groupBoxSTEMoption1.png)
...
![HRTEM options](../../assets/cap-zh-Hant-auto/FormImageSimulator.splitContainer1.groupBoxSimulation.panelModeOptions.groupBoxHREMoption2.png)
...
![STEM options (simulation)](../../assets/cap-zh-Hant-auto/FormImageSimulator.splitContainer1.groupBoxSimulation.panelModeOptions.groupBoxSTEMoption2.png)

- **Bloch wave count** — 與 HRTEM 的作用相同，套用於每個探針位置。
- **Angular resolution** — 探針方向積分中的取樣點數。
- **TDS treatment** — 是否透過溫度因子 *B* 納入熱漫散射。LAADF/HAADF 必須開啟。

### Potential options

![Potential option](../../assets/cap-zh-Hant-auto/FormImageSimulator.splitContainer1.groupBoxSimulation.panelModeOptions.groupBoxPotentialOption.png)
...
![Image properties](../../assets/cap-zh-Hant-auto/FormImageSimulator.splitContainer1.groupBoxSimulation.panelModeOptions.panelImageProperties.groupBoxImageProperty.png)
...
![Adjust](../../assets/cap-zh-Hant-auto/FormImageSimulator.splitContainer1.panelDisplaySettings.groupBoxAdjust.png)

最小/最大亮度、色階、高斯模糊。

### Normalization

![Normalization](../../assets/cap-zh-Hant-auto/FormImageSimulator.splitContainer1.panelDisplaySettings.groupBoxNormalization.png)

### Display

![Display](../../assets/cap-zh-Hant-auto/FormImageSimulator.splitContainer1.panelDisplaySettings.groupBoxDisplay.png)

標籤 (厚度/欠焦)、比例尺、晶胞疊加。

### STEM image

![STEM image](../../assets/cap-zh-Hant-auto/FormImageSimulator.splitContainer1.panelDisplaySettings.groupBoxSTEMoption3.png)
