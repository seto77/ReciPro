...
🌐 [English](../en/13-electron-trajectory.md)  |  **日本語**
...
**電子飛程シミュレータ** は、試料内部の電子の軌跡を **モンテカルロ法** で計算します。入射電子は弾性・非弾性散乱を受け、後方散乱電子の分布（方向・エネルギー・侵入深さ）が集計されます。これらの分布は [EBSDシミュレーション](14-ebsd-simulation.md) の方位・エネルギー・深さの重み付けにも利用されます。
