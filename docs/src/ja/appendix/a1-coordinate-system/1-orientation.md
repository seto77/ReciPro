...
![モニター上に示したReciProの座標軸](../../../assets/references/Coordinates1.png){width=400px}
...
![初期方位：結晶の a / b / c 軸と X / Y / Z 軸の関係。入射ビームは −Z 方向](../../../assets/references/Coordinates2.png){width=300px}
...
![オイラー角の回転軸 — Φ（黄）・θ（水色）・Ψ（マゼンタ）。上が 0°、下が 15° の状態](../../../assets/references/Coordinates3.png){width=400px}
