...
**解決方法**: ランタイムのインストーラを直接ダウンロードできます。[.NET 10.0 ダウンロードページ](https://dotnet.microsoft.com/download/dotnet/10.0) から、ご使用のアーキテクチャ向けの **Windows Desktop Runtime** を選んでください。(Issue [#49](https://github.com/seto77/ReciPro/issues/49))
