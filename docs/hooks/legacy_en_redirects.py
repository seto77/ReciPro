...
LEGACY_EN_RENAMES = {
    ...
    "7-2-x-ray-diffraction": "7-diffraction-simulator/5-x-ray-neutron-diffraction",
    "7-3-ped-simulation": "7-diffraction-simulator/2-ped-simulation",
    "7-4-cbed-simulation": "7-diffraction-simulator/3-cbed-simulation",
    "7-diffraction-simulator/2-x-ray-diffraction": "7-diffraction-simulator/5-x-ray-neutron-diffraction",
    "7-diffraction-simulator/1-x-ray-diffraction": "7-diffraction-simulator/5-x-ray-neutron-diffraction",
    ...
    # 260809Cl: 7.4 に ALCHEMI を新設し X線/中性子を 7.5 (= 5-...) へ繰り下げた
    "7-diffraction-simulator/4-x-ray-neutron-diffraction": "7-diffraction-simulator/5-x-ray-neutron-diffraction",
