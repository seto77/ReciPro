...
namespace Crystallography.Controls
{
    public partial class SaclaControl : UserControl
    {
        ...
        public PointD Foot { set { numericBoxFootX.Value = value.X; numericalTextBoxFootY.Value = value.Y; } get { return new PointD(numericBoxFootX.Value, numericalTextBoxFootY.Value); } }
        ...
        private void numericalTextBoxPixelWidth_ValueChanged(object sender, EventArgs e)
        {
