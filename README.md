...
* *ReciPro* runs on Windows OS with ***.Net Desktop Runtime 8.0*** (not ***.Net Runtime 9.0***), which can be installed from [here](https://dotnet.microsoft.com/download/dotnet/9.0).
