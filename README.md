...
*ReciPro* is developed by [Seto Y.](https://yseto.net/en/home-e) and [Ohtsuka M.](https://researchmap.jp/7000002999?lang=en). The functions and algorithms are presented in [the paper](https://github.com/seto77/ReciPro/blob/master/docs/ReciProSetoOhtsuka2022.pdf).
...
* Download [*ReciPro-setup.msi*](https://github.com/seto77/ReciPro/releases/latest/download/ReciPro-setup.msi) (direct link to the latest version) and execute it. You can also find it on the [releases page](https://github.com/seto77/ReciPro/releases/latest). (Up to v.4.939, the installer was named *ReciProSetup.msi*.)
...
* Scanning Transmission Electron Microscopy image simulation.
  ...
  * **STEM-EDX** elemental maps for the K, L and M lines, computed from inner-shell
    ionization form factors F(s, E₀) rather than from a localized-signal assumption.
    * The form-factor tables are generated by **[Temari](https://github.com/seto77/Temari)**,
      a separate open-source project by the same author that solves the isolated atom
      from scratch — self-consistent field, bound orbitals and distorted continuum
